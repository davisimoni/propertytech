...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="min-w-0">
            ...
            {organization?.dpaAcceptedAt ? (
              <p className="text-sm text-muted-foreground">
                ...
                {DATE_FORMAT.format(organization.dpaAcceptedAt)}. I dati che carichi restano di tua
                proprietà, risiedono su server UE e sono trattati solo per erogare il servizio.
              </p>
            ) : (
      ...
      {/* `scroll-mt-20`: l'intestazione è fissa, e senza margine di ancoraggio
          lo scorrimento verso #prezzi lascerebbe il titolo dei piani nascosto
          sotto la barra. */}
