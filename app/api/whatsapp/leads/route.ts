...
export async function GET(request: Request) {
  ...
  const view: LeadView[] = leads.map((lead) => ({
    ...
    intent: lead.intent,
    sellerPropertyComune: lead.sellerPropertyComune,
    sellerPropertyZona: lead.sellerPropertyZona,
    sellerPropertyType: lead.sellerPropertyType,
    sellerPropertySquareMeters: lead.sellerPropertySquareMeters,
    sellerPropertyCondition: lead.sellerPropertyCondition,
    sellerTimeframe: lead.sellerTimeframe,
    sellerValuationInterest: lead.sellerValuationInterest,
