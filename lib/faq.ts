...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Sì. Database e server principali sono in Unione Europea (Francoforte) e il trattamento è conforme al GDPR. I dati dei tuoi clienti restano di tua proprietà e non vengono usati per addestrare modelli di intelligenza artificiale. Un'eccezione dichiarata: la trascrizione delle note vocali passa dai server di OpenAI, negli Stati Uniti, sotto EU-U.S. Data Privacy Framework e clausole contrattuali standard. L'audio non viene conservato né da noi né dal fornitore per l'addestramento e si cancella subito dopo la trascrizione. L'elenco completo dei fornitori è nell'informativa privacy.",
  },
  {
