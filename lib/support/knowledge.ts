...
${bonusLines()}
Come si usano:
- **Kit Script WhatsApp e Obiezioni** → **Apri il kit**. Contiene due cose distinte, per due interlocutori diversi.
  - **Otto script per il proprietario**, durante l'acquisizione dell'incarico (provvigione troppo alta, "il mio immobile vale di più", più agenzie, "ci devo pensare", "provo da solo", "un'altra agenzia me lo valuta di più", tempi di vendita, documenti). Inserendo nome del proprietario, prezzo richiesto e percentuale di provvigione escono già con quel nome e quelle cifre. Calcola anche provvigione, IVA al 22% e netto al proprietario (il netto non comprende imposte e spese notarili).
  - **Obiezioni di chi compra**, con risposta WhatsApp pronta e la strategia dietro. Senza indicare un immobile si vedono quelle valide in ogni trattativa ("ci devo pensare", "voglio fare un'offerta più bassa", "prima devo vendere casa mia", "ne ho viste altre che costano meno"). Indicando l'immobile e premendo **Genera obiezioni su misura**, l'AI calcola da tre a cinque obiezioni specifiche di quell'immobile (prezzo rispetto alla zona, classe energetica, piano, criticità note).
  - L'immobile si indica in due modi: **cercandolo nel portafoglio** (prezzo, metratura, zona e classe energetica arrivano dalla scheda) oppure **scrivendolo a mano** (tipologia e città o zona; il prezzo è quello già inserito sopra). In entrambi i casi si possono aggiungere **punti di forza** e **criticità note**, che nessuna scheda contiene.
  - L'AI usa **solo** i dati indicati: non deduce difetti che non sono stati scritti, e le risposte non promettono sconti né tempi.
...
- **Checklist e Audit Conformità** → **Apri la checklist**. Dodici voci (titolarità, urbanistica, impianti ed energia, condominio, vincoli e diritti di terzi), ognuna segnata come **C'è**, **Manca** o **Da chiedere**, con la possibilità di aggiungere una **nota** per voce. Dà subito un verdetto (da "Non raccogliere ancora la proposta" a "Pronto per la proposta") e prepara l'elenco dei documenti da chiedere al proprietario, da copiare.
  - **Collegando un immobile del portafoglio** (campo con ricerca in cima alla pagina) la checklist **si salva su quella scheda**: la ritrova chiunque in agenzia la riapra, così il sopralluogo lo può fare una persona e la telefonata all'amministratore un'altra. Senza collegamento resta sulla schermata e finisce comunque nel PDF.
  - **Scarica Report PDF Conformità**: tabella di tutti i controlli con esito e note, indice di vendibilità **documentale** (quante voci risultano a posto sul totale, con le voci bloccanti contate a parte) e l'elenco dei punti da risolvere prima della proposta. Esce con logo e dati dell'agenzia.
  - **Non è uno strumento di AI e non certifica nulla**: non sostituisce il tecnico né il notaio, serve a sapere cosa manca finché c'è tempo. L'indice di vendibilità riguarda i documenti, non il valore di mercato.
...
- Gli utenti possono chiamarli in modi diversi ("kit script", "modulo di valorizzazione", "audit tecnico"): ricollegali sempre al nome reale.
- **Cosa usa l'AI e cosa no**, perché la domanda arriva spesso: nel Kit Script l'AI calcola **solo** le obiezioni su misura (il resto sono testi scritti, sempre uguali); il Report di Valorizzazione lo scrive interamente l'agente; la Checklist non usa AI in nessuna parte.
...
- **Commenti social**: in **Social & Annunci → Commenti Social** si vedono i commenti ricevuti sui post, con un selettore per passare fra **Instagram** e la **Pagina Facebook** collegata. Per ognuno si può rispondere (scrivendo a mano oppure facendo scrivere una bozza all'AI, che resta modificabile prima di pubblicarla) e si può nascondere un commento, scelta reversibile in qualsiasi momento. **La risposta parte solo quando l'agente preme Pubblica**: niente risposte automatiche, perché un commento sotto un post è pubblico e non si può richiamare.
- **Messaggi diretti (DM) di Instagram e Facebook**: non vengono letti né gestiti, né quelli della Pagina né quelli del profilo. Le risposte automatiche ai clienti avvengono solo su **WhatsApp**.
...
- **Non risponde da solo ai commenti** (né Instagram né Facebook): le bozze le scrive l'AI, ma a pubblicare è sempre l'agente. E **non legge i messaggi diretti** di Instagram e Facebook: lì non arriva. Le risposte automatiche sono solo su WhatsApp.
