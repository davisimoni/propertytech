...
/**
 * A chi va una notifica di servizio dell'agenzia (email e push).
 *
 ...
 *
 * `id` serve alle notifiche push, che si inviano ai dispositivi dell'utente e
 * non a un indirizzo.
 */
...
const CAMPI = { id: true, email: true, firstName: true } as const;
 ...
 * e chi può richiamarlo subito; il titolare è il ripiego che c'è sempre.
 */
