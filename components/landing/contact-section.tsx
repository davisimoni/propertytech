              ...
              <li className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <a
                    ...
                    className="inline-flex min-h-11 items-center break-all text-sm text-muted-foreground transition-colors duration-200 hover:text-primary md:mouse:min-h-0"
                  >
                    {CONTACT_EMAIL}
                  </a>
                </div>
